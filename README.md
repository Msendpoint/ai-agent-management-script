...
git clone https://github.com/Msendpoint/ai-agent-management-script.git
cd ai-agent-management-script
...
.\scripts\ai-agent-management-script.ps1
```
...
**[Manage AI Agent Sprawl with Microsoft Intune](https://msendpoint.com/article/manage-ai-agent-sprawl-with-microsoft-intune)**
...
- Report issues: [GitHub Issues](https://github.com/Msendpoint/ai-agent-management-script/issues)

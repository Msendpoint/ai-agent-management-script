<#
.SYNOPSIS
    One-click installer and launcher for AI Agent Management Script
...
Write-Host "    AI Agent Management Script" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/ai-agent-management-script.ps1"
